...
#[derive(Debug)]
pub struct ContextGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContextGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContextGrid processing");
    
    let mut processor = ContextGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContextGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContextGridProcessor::new(false);
